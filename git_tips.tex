...
\paragraph{}
Now, how to do that? The process is quite simple. First, make sure that the main branch is synchronised with the remote. Then, \hyperref[sec:switching]{switch} to the feature branch. Right-click the project name and choose the following:\newline
